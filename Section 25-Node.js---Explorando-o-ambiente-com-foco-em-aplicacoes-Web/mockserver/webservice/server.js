...
//Transformando o valor dos objetos em uma string
/*  ERA SÓ PRA EXEMPLO AGORA A GENTE VAI USAR DIRETO DO APP*/
...
const server = createServer((req, res) => {
    ...
    // CHAT FALOU QUE PREICSA COMENTAR ISSO PQ ISSO TA DANDO ERRO
    res.end(mockData);


    //RES é o método de requisição do client = resposta do servidor
});
